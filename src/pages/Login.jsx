  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 mb-6">
        ...
        <Button variant="outline" className="w-full h-12 text-sm font-medium bg-black text-white hover:bg-gray-900 border-black" onClick={handleApple}>
        ...
        <Button variant="outline" className="w-full h-12 text-sm font-medium bg-[#1877F2] text-white hover:bg-[#166FE5] border-[#1877F2]" onClick={handleFacebook}>
